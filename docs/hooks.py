...
def copy_changelog_and_license(*args, **kwargs):
    ...
    shutil.copy(
        "config/output_files_references.yaml",
        "docs/includes/output_files_references.yaml",
    )
    shutil.copy("config/config.yaml", "docs/includes/config.yaml")
    shutil.copy("config/config_references.yaml",
                "docs/includes/config_references.yaml")
